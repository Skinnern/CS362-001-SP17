...
public class TestTimeTable {
    ...
    @Test
    public void ApptRangeMuteTest()	throws Throwable	{
        TimeTable testTable = new TimeTable();
        LinkedList<Appt> appts;
        appts = new LinkedList<Appt>();
        appts.add(new Appt(15, 30, 29, 4, 2017, "Party Time", "Excellent!"));
        appts.add(new Appt(18, 30, 30, 4, 2017, "j'attend mon cours", "mon cours de l'informatiques!"));
